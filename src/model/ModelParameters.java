...
public class ModelParameters {
	...
	public ArrayList<TopicModel> topicModelList_LastIteration;
	public boolean includeCurrentDomainAsKnowledgeExtraction = true;

	// ------------------------------------------------------------------------
	// Parameters specific to LTM (ICML 2014).
	// ------------------------------------------------------------------------
	...
	public int minimumSupport = 5;
	public double minimumSupportPercentage = 0.3;
	// Scale from PMI to GPU model parameter.
	public double pmiScaleToGPU = 0.3;
	// Threshold for topic matching in knowledge extraction.
	public double topicMatchingKLDivergenceThreshold = 10.0;
